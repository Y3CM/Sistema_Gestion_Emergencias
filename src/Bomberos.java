...
public class Bomberos extends Emergencia implements Responder {

    private int camion;
    

    public Bomberos(String tipo, NivelGravedad nivelGravedad, int tiempoRespuesta, String ubicacion) {
