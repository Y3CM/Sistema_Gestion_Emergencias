...
public class Policia extends Emergencia implements Responder{

    private int patrullas;

    public Policia (String tipo, NivelGravedad nivelGravedad, int tiempoRespuesta, String ubicacion) {
